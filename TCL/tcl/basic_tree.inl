...
:   children(container_type()), element_(value), pParent_node(0), 
    tree_type_allocator(std::allocator<tree_type>())
{
}
...
:   children(container_type()), element_(rhs.get()), pParent_node(0), 
    tree_type_allocator(std::allocator<tree_type>())
{
}
